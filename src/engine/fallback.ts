...
const QUIT_JOB: Seed[] = [
  ...
  { text: 'Tell your sister tonight', horizon: 'immediate', severity: 'tense', angle: 104 },
  ...
  { text: 'Three months saved becomes six', horizon: 'long', severity: 'tense', angle: 15 },
...
const TELL_FEEL: Seed[] = [
  ...
  { text: 'You finally say it out loud', horizon: 'immediate', severity: 'calm', angle: 70 },
  { text: 'They look at you for a long time', horizon: 'immediate', severity: 'tense', angle: 118 },
  { text: 'A long silence, then a small smile', horizon: 'immediate', severity: 'heavy', angle: 165 },
  { text: 'They write back at 2am', horizon: 'short', severity: 'calm', angle: 210 },
  ...
  { text: 'Your friendship has a new shape', horizon: 'long', severity: 'calm', angle: 40 },
...
const MOVE_AWAY: Seed[] = [
  ...
  { text: 'A long goodbye dinner', horizon: 'immediate', severity: 'tense', angle: 158 },
...
const DEFAULT: Seed[] = [
  ...
  { text: 'Someone eventually finds out', horizon: 'immediate', severity: 'tense', angle: 170 },
  ...
  { text: 'You write a long letter and send it', horizon: 'short', severity: 'tense', angle: 305 },
  { text: 'A photograph means something else now', horizon: 'long', severity: 'calm', angle: 345 },
